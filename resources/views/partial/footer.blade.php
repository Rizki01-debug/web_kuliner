...
<div class="col-lg-3 col-md-6">
    ...
    <p>
        Dapatkan info terbaru melalui 
        <b>{{ $footer->newsletter_email ?? $footer->email ?? 'info@kuliner.com' }}</b>
    </p>
<div class="input-group" style="max-width: 400px;">
    <form action="{{ route('newsletter.store') }}" method="POST" class="d-flex w-100">
        @csrf
        <input 
            type="email" 
            name="email"
