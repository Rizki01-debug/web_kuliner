...
@section('content')
    ...
    <div class="container mx-auto px-4 py-10">
        <h1 class="text-3xl font-bold mb-10 text-center">Our Services</h1>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            @forelse($services as $service)
                <div class="bg-white shadow rounded-lg p-6 hover:shadow-lg transition">
                    ...
                    @else
                        <div class="w-full h-48 flex items-center justify-center bg-gray-100 rounded-md mb-4 text-gray-500">
                            No Icon
                        </div>
                    @endif
            ...
            @empty
                <p class="text-gray-500 col-span-3 text-center">No services available.</p>
            @endforelse
        </div>
